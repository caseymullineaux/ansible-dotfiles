...
# Load the syntax highlighting plugin theme
# Must be done before the plugin is loaded
...
plugins=(git colorize docker zsh-syntax-highlighting)
...
# Configure GitHub Copilot CLI aliases
